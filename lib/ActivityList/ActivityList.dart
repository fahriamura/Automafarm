...
class ActivityList extends StatefulWidget {
  const ActivityList({Key? key, this.animationController,required this.userID}) : super(key: key);
  final int userID; 
